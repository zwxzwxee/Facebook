...
export default function Intro({ detailss, visitor, user, setOtherName }) {
  const [details, setDetails] = useState();
  // everytime the detailss changes, it will be loaded into details
  useEffect(() => {
    setDetails(detailss);
    setInfo(detailss);
  }, [detailss]);
  //   at the beginning the details are empty,
  //   only after the detailss is delivered to details, the info will have values.
  const initial = {
